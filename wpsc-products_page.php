					...
					<div class="imagecol" id="imagecol_<?php echo wpsc_the_product_id(); ?>">
						...
						?>
							<a href="<?php echo wpsc_the_product_permalink(); ?>">
								<img id="product_image_<?php echo wpsc_the_product_id(); ?>" alt="<?php echo wpsc_the_product_title(); ?>" title="<?php echo wpsc_the_product_title(); ?>" src="<?php echo wpsc_the_product_image(); ?>"/>
							</a>
						<?php else: ?>
								<a href="<?php echo wpsc_the_product_permalink(); ?>">
